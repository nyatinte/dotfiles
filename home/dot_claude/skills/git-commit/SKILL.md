---
allowed-tools: Read(*), Bash(git commit *), Bash(git log *), Bash(git diff *), Bash(git status *), Bash(git branch *), Bash(*analyze-git-diff.sh*), Bash(*summarize-uncommitted-diff.sh*), Bash(git add *), Bash(git commit *), Bash(git log *), Bash(git diff *), Bash(git status *), Bash(git branch *), Bash(*/.claude/skills/git-commit/scripts/analyze-git-diff.sh), Bash(*/.claude/skills/git-commit/scripts/summarize-uncommitted-diff.sh)
