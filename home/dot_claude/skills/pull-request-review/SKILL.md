---
allowed-tools: Read(*), Glob(*), Grep(*), Write(.claude/reviews/*), Bash(gh pr view *), Bash(gh pr diff *), Bash(gh issue view *), Bash(bash */.claude/skills/pull-request-review/scripts/get-reviews.sh), Bash(mkdir */.claude/reviews/*)
