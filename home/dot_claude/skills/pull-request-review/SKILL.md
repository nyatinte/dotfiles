---
allowed-tools: Read(*), Glob(*), Grep(*), Write(.claude/reviews/*), Bash(gh pr view *), Bash(gh pr diff *), Bash(gh issue view *), Bash(bash */p.claude/skills/pull-request-review/scripts/get-reviews.sh), Bash(mkdir */.claude/reviews/*)
...
2. `.claude/skills/pull-request-review/scripts/get-reviews.sh` を実行して、既存のレビューコメントを確認する
